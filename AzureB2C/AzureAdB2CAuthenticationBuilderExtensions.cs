...
namespace HealthCare.API.AzureB2C
{
  public static class AzureAdB2CAuthenticationBuilderExtensions
  {
    ...
    public class OpenIdConnectOptionsSetup : IConfigureNamedOptions<OpenIdConnectOptions>
    {
      ...
      public OpenIdConnectOptionsSetup(AzureAdB2C b2cOptions)
      {
      ...
      public Task OnRedirectToIdentityProvider(RedirectContext context)
      {
        ...
        if (context.Properties.Items.TryGetValue(AzureAdB2C.PolicyAuthenticationProperty, out var policy) &&
            !policy.Equals(defaultPolicy))
        {
          context.ProtocolMessage.Scope = OpenIdConnectScope.OpenIdProfile;
          context.ProtocolMessage.ResponseType = OpenIdConnectResponseType.IdToken;
          context.ProtocolMessage.IssuerAddress = context.ProtocolMessage.IssuerAddress.ToLower().Replace(defaultPolicy.ToLower(), policy.ToLower());
          context.Properties.Items.Remove(AzureAdB2C.PolicyAuthenticationProperty);
        }
